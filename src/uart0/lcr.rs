...
impl From<Uart0LcrWlsEnum> for u8 {
    #[inline(always)]
    fn from(variant: Uart0LcrWlsEnum) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Uart0LcrWlsEnum {
    type Ux = u8;
}
impl crate::IsEnum for Uart0LcrWlsEnum {}
#[doc = "Field `WLS` reader - Word Length Select."]
pub type WlsR = crate::FieldReader<Uart0LcrWlsEnum>;
impl WlsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrWlsEnum {
        match self.bits {
            0 => Uart0LcrWlsEnum::_5BitCharacterLeng,
            1 => Uart0LcrWlsEnum::_6BitCharacterLeng,
            2 => Uart0LcrWlsEnum::_7BitCharacterLeng,
            3 => Uart0LcrWlsEnum::_8BitCharacterLeng,
            _ => unreachable!(),
        }
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn _5_bit_character_leng(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrWlsEnum::_5BitCharacterLeng)
    }
    #[doc = "6-bit character length"]
    #[inline(always)]
    pub fn _6_bit_character_leng(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrWlsEnum::_6BitCharacterLeng)
    }
    #[doc = "7-bit character length"]
    #[inline(always)]
    pub fn _7_bit_character_leng(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrWlsEnum::_7BitCharacterLeng)
    }
    #[doc = "8-bit character length"]
    #[inline(always)]
    pub fn _8_bit_character_leng(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrWlsEnum::_8BitCharacterLeng)
    }
}
#[doc = "Stop Bit Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0LcrSbsEnum {
    #[doc = "0: 1 stop bit."]
    _1StopBit_ = 0,
    #[doc = "1: 2 stop bits (1.5 if UnLCR\\[1:0\\]=00)."]
    _2StopBits1_5If_ = 1,
}
impl From<Uart0LcrSbsEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0LcrSbsEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SBS` reader - Stop Bit Select"]
pub type SbsR = crate::BitReader<Uart0LcrSbsEnum>;
impl SbsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrSbsEnum {
        match self.bits {
            false => Uart0LcrSbsEnum::_1StopBit_,
            true => Uart0LcrSbsEnum::_2StopBits1_5If_,
        }
    }
    #[doc = "1 stop bit."]
    #[inline(always)]
    pub fn is_1_stop_bit_(&self) -> bool {
        *self == Uart0LcrSbsEnum::_1StopBit_
    }
    #[doc = "2 stop bits (1.5 if UnLCR\\[1:0\\]=00)."]
    #[inline(always)]
    pub fn is_2_stop_bits_1_5_if_(&self) -> bool {
        *self == Uart0LcrSbsEnum::_2StopBits1_5If_
    }
}
#[doc = "Field `SBS` writer - Stop Bit Select"]
pub type SbsW<'a, REG> = crate::BitWriter<'a, REG, Uart0LcrSbsEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn _1_stop_bit_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrSbsEnum::_1StopBit_)
    }
    #[doc = "2 stop bits (1.5 if UnLCR\\[1:0\\]=00)."]
    #[inline(always)]
    pub fn _2_stop_bits_1_5_if_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrSbsEnum::_2StopBits1_5If_)
    }
}
#[doc = "Parity Enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0LcrPeEnum {
...
impl From<Uart0LcrPeEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0LcrPeEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PE` reader - Parity Enable."]
pub type PeR = crate::BitReader<Uart0LcrPeEnum>;
impl PeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrPeEnum {
        match self.bits {
            false => Uart0LcrPeEnum::DisableParityGener,
            true => Uart0LcrPeEnum::EnableParityGenera,
        }
    }
    #[doc = "Disable parity generation and checking."]
    #[inline(always)]
    pub fn is_disable_parity_gener(&self) -> bool {
        *self == Uart0LcrPeEnum::DisableParityGener
    }
    #[doc = "Enable parity generation and checking."]
    #[inline(always)]
    pub fn is_enable_parity_genera(&self) -> bool {
        *self == Uart0LcrPeEnum::EnableParityGenera
    }
}
#[doc = "Field `PE` writer - Parity Enable."]
pub type PeW<'a, REG> = crate::BitWriter<'a, REG, Uart0LcrPeEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable_parity_gener(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPeEnum::DisableParityGener)
    }
    #[doc = "Enable parity generation and checking."]
    #[inline(always)]
    pub fn enable_parity_genera(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPeEnum::EnableParityGenera)
    }
}
#[doc = "Parity Select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Uart0LcrPsEnum {
...
impl From<Uart0LcrPsEnum> for u8 {
    #[inline(always)]
    fn from(variant: Uart0LcrPsEnum) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Uart0LcrPsEnum {
    type Ux = u8;
}
impl crate::IsEnum for Uart0LcrPsEnum {}
#[doc = "Field `PS` reader - Parity Select"]
pub type PsR = crate::FieldReader<Uart0LcrPsEnum>;
impl PsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrPsEnum {
        match self.bits {
            0 => Uart0LcrPsEnum::OddParityNumberO,
            1 => Uart0LcrPsEnum::EvenParityNumber_,
            2 => Uart0LcrPsEnum::Forced1StickParit,
            3 => Uart0LcrPsEnum::Forced0StickParit,
            _ => unreachable!(),
        }
    }
    ...
    pub fn is_odd_parity_number_o(&self) -> bool {
        *self == Uart0LcrPsEnum::OddParityNumberO
    }
    ...
    pub fn is_even_parity_number_(&self) -> bool {
        *self == Uart0LcrPsEnum::EvenParityNumber_
    }
    #[doc = "Forced 1 stick parity."]
    #[inline(always)]
    pub fn is_forced_1_stick_parit(&self) -> bool {
        *self == Uart0LcrPsEnum::Forced1StickParit
    }
    #[doc = "Forced 0 stick parity."]
    #[inline(always)]
    pub fn is_forced_0_stick_parit(&self) -> bool {
        *self == Uart0LcrPsEnum::Forced0StickParit
    }
}
#[doc = "Field `PS` writer - Parity Select"]
pub type PsW<'a, REG> = crate::FieldWriter<'a, REG, 2, Uart0LcrPsEnum, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn odd_parity_number_o(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPsEnum::OddParityNumberO)
    }
    #[doc = "Even Parity. Number of 1s in the transmitted character and the attached parity bit will be even."]
    #[inline(always)]
    pub fn even_parity_number_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPsEnum::EvenParityNumber_)
    }
    #[doc = "Forced 1 stick parity."]
    #[inline(always)]
    pub fn forced_1_stick_parit(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPsEnum::Forced1StickParit)
    }
    #[doc = "Forced 0 stick parity."]
    #[inline(always)]
    pub fn forced_0_stick_parit(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrPsEnum::Forced0StickParit)
    }
}
#[doc = "Break Control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0LcrBcEnum {
...
impl From<Uart0LcrBcEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0LcrBcEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `BC` reader - Break Control"]
pub type BcR = crate::BitReader<Uart0LcrBcEnum>;
impl BcR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrBcEnum {
        match self.bits {
            false => Uart0LcrBcEnum::DisableBreakTransm,
            true => Uart0LcrBcEnum::EnableBreakTransmi,
        }
    }
    #[doc = "Disable break transmission."]
    #[inline(always)]
    pub fn is_disable_break_transm(&self) -> bool {
        *self == Uart0LcrBcEnum::DisableBreakTransm
    }
    ...
    pub fn is_enable_break_transmi(&self) -> bool {
        *self == Uart0LcrBcEnum::EnableBreakTransmi
    }
}
#[doc = "Field `BC` writer - Break Control"]
pub type BcW<'a, REG> = crate::BitWriter<'a, REG, Uart0LcrBcEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable_break_transm(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrBcEnum::DisableBreakTransm)
    }
    #[doc = "Enable break transmission. Output pin UARTn TXD is forced to logic 0 when UnLCR\\[6\\] is active high."]
    #[inline(always)]
    pub fn enable_break_transmi(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrBcEnum::EnableBreakTransmi)
    }
}
#[doc = "Divisor Latch Access Bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0LcrDlabEnum {
    #[doc = "0: Disable access to Divisor Latches."]
    DisableAccessToDi = 0,
    #[doc = "1: Enable access to Divisor Latches."]
    EnableAccessToDiv = 1,
}
impl From<Uart0LcrDlabEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0LcrDlabEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DLAB` reader - Divisor Latch Access Bit"]
pub type DlabR = crate::BitReader<Uart0LcrDlabEnum>;
impl DlabR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0LcrDlabEnum {
        match self.bits {
            false => Uart0LcrDlabEnum::DisableAccessToDi,
            true => Uart0LcrDlabEnum::EnableAccessToDiv,
        }
    }
    #[doc = "Disable access to Divisor Latches."]
    #[inline(always)]
    pub fn is_disable_access_to_di(&self) -> bool {
        *self == Uart0LcrDlabEnum::DisableAccessToDi
    }
    #[doc = "Enable access to Divisor Latches."]
    #[inline(always)]
    pub fn is_enable_access_to_div(&self) -> bool {
        *self == Uart0LcrDlabEnum::EnableAccessToDiv
    }
}
#[doc = "Field `DLAB` writer - Divisor Latch Access Bit"]
pub type DlabW<'a, REG> = crate::BitWriter<'a, REG, Uart0LcrDlabEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable_access_to_di(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrDlabEnum::DisableAccessToDi)
    }
    #[doc = "Enable access to Divisor Latches."]
    #[inline(always)]
    pub fn enable_access_to_div(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0LcrDlabEnum::EnableAccessToDiv)
    }
}
impl R {
