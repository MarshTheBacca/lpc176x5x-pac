...
pub enum Uart0IirIntstatusEnum {
    #[doc = "0: At least one interrupt is pending."]
    AtLeastOneInterru = 0,
    #[doc = "1: No interrupt is pending."]
    NoInterruptIsPend = 1,
}
impl From<Uart0IirIntstatusEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0IirIntstatusEnum) -> Self {
        variant as u8 != 0
    }
}
...
pub type IntstatusR = crate::BitReader<Uart0IirIntstatusEnum>;
impl IntstatusR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0IirIntstatusEnum {
        match self.bits {
            false => Uart0IirIntstatusEnum::AtLeastOneInterru,
            true => Uart0IirIntstatusEnum::NoInterruptIsPend,
        }
    }
    #[doc = "At least one interrupt is pending."]
    #[inline(always)]
    pub fn is_at_least_one_interru(&self) -> bool {
        *self == Uart0IirIntstatusEnum::AtLeastOneInterru
    }
    #[doc = "No interrupt is pending."]
    #[inline(always)]
    pub fn is_no_interrupt_is_pend(&self) -> bool {
        *self == Uart0IirIntstatusEnum::NoInterruptIsPend
    }
}
...
impl From<Uart0IirIntidEnum> for u8 {
    #[inline(always)]
    fn from(variant: Uart0IirIntidEnum) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Uart0IirIntidEnum {
    type Ux = u8;
}
impl crate::IsEnum for Uart0IirIntidEnum {}
...
pub type IntidR = crate::FieldReader<Uart0IirIntidEnum>;
impl IntidR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<Uart0IirIntidEnum> {
        match self.bits {
            3 => Some(Uart0IirIntidEnum::_1ReceiveLineS),
            2 => Some(Uart0IirIntidEnum::_2a_ReceiveDataAv),
            6 => Some(Uart0IirIntidEnum::_2b_CharacterTime_),
            1 => Some(Uart0IirIntidEnum::_3ThreInterrupt),
            _ => None,
        }
    }
