...
impl From<Uart0FcrFifoenEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0FcrFifoenEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FIFOEN` writer - FIFO Enable."]
pub type FifoenW<'a, REG> = crate::BitWriter<'a, REG, Uart0FcrFifoenEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn uartn_fifos_are_disa(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0FcrFifoenEnum::UartnFifosAreDisa)
    }
    ...
    pub fn active_high_enable_f(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0FcrFifoenEnum::ActiveHighEnableF)
    }
}
#[doc = "RX FIFO Reset.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0FcrRxfiforesEnum {
...
impl From<Uart0FcrRxfiforesEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0FcrRxfiforesEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RXFIFORES` writer - RX FIFO Reset."]
pub type RxfiforesW<'a, REG> = crate::BitWriter<'a, REG, Uart0FcrRxfiforesEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_impact_on_either_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0FcrRxfiforesEnum::NoImpactOnEither_)
    }
    ...
    pub fn writing_a_logic_1_to(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0FcrRxfiforesEnum::WritingALogic1To)
    }
}
#[doc = "TX FIFO Reset.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0FcrTxfiforesEnum {
    #[doc = "0: No impact on either of UARTn FIFOs."]
    NoImpactOnEither_ = 0,
...
impl From<Uart0FcrTxfiforesEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0FcrTxfiforesEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TXFIFORES` writer - TX FIFO Reset."]
pub type TxfiforesW<'a, REG> = crate::BitWriter<'a, REG, Uart0FcrTxfiforesEnum>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Uart0FcrRxtriglvlEnum {
...
impl From<Uart0FcrRxtriglvlEnum> for u8 {
    #[inline(always)]
    fn from(variant: Uart0FcrRxtriglvlEnum) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Uart0FcrRxtriglvlEnum {
    type Ux = u8;
}
impl crate::IsEnum for Uart0FcrRxtriglvlEnum {}
...
pub type RxtriglvlW<'a, REG> = crate::FieldWriter<'a, REG, 2, Uart0FcrRxtriglvlEnum, crate::Safe>;
