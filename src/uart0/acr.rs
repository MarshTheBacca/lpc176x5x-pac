...
impl From<Uart0AcrStartEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0AcrStartEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `START` reader - Start bit. This bit is automatically cleared after auto-baud completion."]
pub type StartR = crate::BitReader<Uart0AcrStartEnum>;
impl StartR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0AcrStartEnum {
        match self.bits {
            false => Uart0AcrStartEnum::AutoBaudStopAuto,
            true => Uart0AcrStartEnum::AutoBaudStartAut,
        }
    }
    #[doc = "Auto-baud stop (auto-baud is not running)."]
    #[inline(always)]
    pub fn is_auto_baud_stop_auto(&self) -> bool {
        *self == Uart0AcrStartEnum::AutoBaudStopAuto
    }
    ...
    pub fn is_auto_baud_start_aut(&self) -> bool {
        *self == Uart0AcrStartEnum::AutoBaudStartAut
    }
}
#[doc = "Field `START` writer - Start bit. This bit is automatically cleared after auto-baud completion."]
pub type StartW<'a, REG> = crate::BitWriter<'a, REG, Uart0AcrStartEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn auto_baud_stop_auto(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrStartEnum::AutoBaudStopAuto)
    }
    #[doc = "Auto-baud start (auto-baud is running). Auto-baud run bit. This bit is automatically cleared after auto-baud completion."]
    #[inline(always)]
    pub fn auto_baud_start_aut(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrStartEnum::AutoBaudStartAut)
    }
}
#[doc = "Auto-baud mode select bit.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0AcrModeEnum {
    #[doc = "0: Mode 0."]
    Mode0_ = 0,
    #[doc = "1: Mode 1."]
    Mode1_ = 1,
}
impl From<Uart0AcrModeEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0AcrModeEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `MODE` reader - Auto-baud mode select bit."]
pub type ModeR = crate::BitReader<Uart0AcrModeEnum>;
impl ModeR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0AcrModeEnum {
        match self.bits {
            false => Uart0AcrModeEnum::Mode0_,
            true => Uart0AcrModeEnum::Mode1_,
        }
    }
    #[doc = "Mode 0."]
    #[inline(always)]
    pub fn is_mode_0_(&self) -> bool {
        *self == Uart0AcrModeEnum::Mode0_
    }
    #[doc = "Mode 1."]
    #[inline(always)]
    pub fn is_mode_1_(&self) -> bool {
        *self == Uart0AcrModeEnum::Mode1_
    }
}
#[doc = "Field `MODE` writer - Auto-baud mode select bit."]
pub type ModeW<'a, REG> = crate::BitWriter<'a, REG, Uart0AcrModeEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn mode_0_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrModeEnum::Mode0_)
    }
    #[doc = "Mode 1."]
    #[inline(always)]
    pub fn mode_1_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrModeEnum::Mode1_)
    }
}
#[doc = "Restart bit.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0AcrAutorestartEnum {
    #[doc = "0: No restart."]
    NoRestart_ = 0,
    #[doc = "1: Restart in case of time-out (counter restarts at next UARTn Rx falling edge)"]
    RestartInCaseOfT = 1,
}
impl From<Uart0AcrAutorestartEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0AcrAutorestartEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `AUTORESTART` reader - Restart bit."]
pub type AutorestartR = crate::BitReader<Uart0AcrAutorestartEnum>;
impl AutorestartR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0AcrAutorestartEnum {
        match self.bits {
            false => Uart0AcrAutorestartEnum::NoRestart_,
            true => Uart0AcrAutorestartEnum::RestartInCaseOfT,
        }
    }
    #[doc = "No restart."]
    #[inline(always)]
    pub fn is_no_restart_(&self) -> bool {
        *self == Uart0AcrAutorestartEnum::NoRestart_
    }
    #[doc = "Restart in case of time-out (counter restarts at next UARTn Rx falling edge)"]
    #[inline(always)]
    pub fn is_restart_in_case_of_t(&self) -> bool {
        *self == Uart0AcrAutorestartEnum::RestartInCaseOfT
    }
}
#[doc = "Field `AUTORESTART` writer - Restart bit."]
pub type AutorestartW<'a, REG> = crate::BitWriter<'a, REG, Uart0AcrAutorestartEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_restart_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAutorestartEnum::NoRestart_)
    }
    #[doc = "Restart in case of time-out (counter restarts at next UARTn Rx falling edge)"]
    #[inline(always)]
    pub fn restart_in_case_of_t(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAutorestartEnum::RestartInCaseOfT)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0AcrAbeointclrEnum {
    #[doc = "0: No impact."]
    NoImpact_ = 0,
    #[doc = "1: Clear the corresponding interrupt in the IIR."]
    ClearTheCorrespond = 1,
}
impl From<Uart0AcrAbeointclrEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0AcrAbeointclrEnum) -> Self {
        variant as u8 != 0
    }
}
...
pub type AbeointclrR = crate::BitReader<Uart0AcrAbeointclrEnum>;
impl AbeointclrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0AcrAbeointclrEnum {
        match self.bits {
            false => Uart0AcrAbeointclrEnum::NoImpact_,
            true => Uart0AcrAbeointclrEnum::ClearTheCorrespond,
        }
    }
    #[doc = "No impact."]
    #[inline(always)]
    pub fn is_no_impact_(&self) -> bool {
        *self == Uart0AcrAbeointclrEnum::NoImpact_
    }
    #[doc = "Clear the corresponding interrupt in the IIR."]
    #[inline(always)]
    pub fn is_clear_the_correspond(&self) -> bool {
        *self == Uart0AcrAbeointclrEnum::ClearTheCorrespond
    }
}
...
pub type AbeointclrW<'a, REG> = crate::BitWriter<'a, REG, Uart0AcrAbeointclrEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn no_impact_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAbeointclrEnum::NoImpact_)
    }
    #[doc = "Clear the corresponding interrupt in the IIR."]
    #[inline(always)]
    pub fn clear_the_correspond(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAbeointclrEnum::ClearTheCorrespond)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart0AcrAbtointclrEnum {
    #[doc = "0: No impact."]
    NoImpact_ = 0,
    #[doc = "1: Clear the corresponding interrupt in the IIR."]
    ClearTheCorrespond = 1,
}
impl From<Uart0AcrAbtointclrEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart0AcrAbtointclrEnum) -> Self {
        variant as u8 != 0
    }
}
...
pub type AbtointclrR = crate::BitReader<Uart0AcrAbtointclrEnum>;
impl AbtointclrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart0AcrAbtointclrEnum {
        match self.bits {
            false => Uart0AcrAbtointclrEnum::NoImpact_,
            true => Uart0AcrAbtointclrEnum::ClearTheCorrespond,
        }
    }
    #[doc = "No impact."]
    #[inline(always)]
    pub fn is_no_impact_(&self) -> bool {
        *self == Uart0AcrAbtointclrEnum::NoImpact_
    }
    #[doc = "Clear the corresponding interrupt in the IIR."]
    #[inline(always)]
    pub fn is_clear_the_correspond(&self) -> bool {
        *self == Uart0AcrAbtointclrEnum::ClearTheCorrespond
    }
}
...
pub type AbtointclrW<'a, REG> = crate::BitWriter<'a, REG, Uart0AcrAbtointclrEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn no_impact_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAbtointclrEnum::NoImpact_)
    }
    #[doc = "Clear the corresponding interrupt in the IIR."]
    #[inline(always)]
    pub fn clear_the_correspond(self) -> &'a mut crate::W<REG> {
        self.variant(Uart0AcrAbtointclrEnum::ClearTheCorrespond)
    }
}
impl R {
