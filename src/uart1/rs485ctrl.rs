...
pub enum Uart1Rs485ctrlNmmenEnum {
    #[doc = "0: Disabled."]
    Disabled_ = 0,
...
impl From<Uart1Rs485ctrlNmmenEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlNmmenEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `NMMEN` reader - RS-485/EIA-485 Normal Multidrop Mode (NMM) mode select."]
pub type NmmenR = crate::BitReader<Uart1Rs485ctrlNmmenEnum>;
impl NmmenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlNmmenEnum {
        match self.bits {
            false => Uart1Rs485ctrlNmmenEnum::Disabled_,
            true => Uart1Rs485ctrlNmmenEnum::EnabledInThisMod,
        }
    }
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn is_disabled_(&self) -> bool {
        *self == Uart1Rs485ctrlNmmenEnum::Disabled_
    }
    ...
    pub fn is_enabled_in_this_mod(&self) -> bool {
        *self == Uart1Rs485ctrlNmmenEnum::EnabledInThisMod
    }
}
#[doc = "Field `NMMEN` writer - RS-485/EIA-485 Normal Multidrop Mode (NMM) mode select."]
pub type NmmenW<'a, REG> = crate::BitWriter<'a, REG, Uart1Rs485ctrlNmmenEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disabled_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlNmmenEnum::Disabled_)
    }
    #[doc = "Enabled. In this mode, an address is detected when a received byte causes the UART to set the parity error and generate an interrupt."]
    #[inline(always)]
    pub fn enabled_in_this_mod(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlNmmenEnum::EnabledInThisMod)
    }
}
#[doc = "Receive enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart1Rs485ctrlRxdisEnum {
    #[doc = "0: Enabled."]
    Enabled_ = 0,
    #[doc = "1: Disabled."]
    Disabled_ = 1,
}
impl From<Uart1Rs485ctrlRxdisEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlRxdisEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RXDIS` reader - Receive enable."]
pub type RxdisR = crate::BitReader<Uart1Rs485ctrlRxdisEnum>;
impl RxdisR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlRxdisEnum {
        match self.bits {
            false => Uart1Rs485ctrlRxdisEnum::Enabled_,
            true => Uart1Rs485ctrlRxdisEnum::Disabled_,
        }
    }
    #[doc = "Enabled."]
    #[inline(always)]
    pub fn is_enabled_(&self) -> bool {
        *self == Uart1Rs485ctrlRxdisEnum::Enabled_
    }
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn is_disabled_(&self) -> bool {
        *self == Uart1Rs485ctrlRxdisEnum::Disabled_
    }
}
#[doc = "Field `RXDIS` writer - Receive enable."]
pub type RxdisW<'a, REG> = crate::BitWriter<'a, REG, Uart1Rs485ctrlRxdisEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn enabled_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlRxdisEnum::Enabled_)
    }
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn disabled_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlRxdisEnum::Disabled_)
    }
}
#[doc = "Auto Address Detect (AAD) enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart1Rs485ctrlAadenEnum {
    #[doc = "0: Disabled."]
    Disabled_ = 0,
    #[doc = "1: Enabled."]
    Enabled_ = 1,
}
impl From<Uart1Rs485ctrlAadenEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlAadenEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `AADEN` reader - Auto Address Detect (AAD) enable."]
pub type AadenR = crate::BitReader<Uart1Rs485ctrlAadenEnum>;
impl AadenR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlAadenEnum {
        match self.bits {
            false => Uart1Rs485ctrlAadenEnum::Disabled_,
            true => Uart1Rs485ctrlAadenEnum::Enabled_,
        }
    }
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn is_disabled_(&self) -> bool {
        *self == Uart1Rs485ctrlAadenEnum::Disabled_
    }
    #[doc = "Enabled."]
    #[inline(always)]
    pub fn is_enabled_(&self) -> bool {
        *self == Uart1Rs485ctrlAadenEnum::Enabled_
    }
}
#[doc = "Field `AADEN` writer - Auto Address Detect (AAD) enable."]
pub type AadenW<'a, REG> = crate::BitWriter<'a, REG, Uart1Rs485ctrlAadenEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlAadenEnum::Disabled_)
    }
    #[doc = "Enabled."]
    #[inline(always)]
    pub fn enabled_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlAadenEnum::Enabled_)
    }
}
#[doc = "Direction control.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart1Rs485ctrlSelEnum {
...
impl From<Uart1Rs485ctrlSelEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlSelEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SEL` reader - Direction control."]
pub type SelR = crate::BitReader<Uart1Rs485ctrlSelEnum>;
impl SelR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlSelEnum {
        match self.bits {
            false => Uart1Rs485ctrlSelEnum::RtsIfDirectionCo,
            true => Uart1Rs485ctrlSelEnum::DtrIfDirectionCo,
        }
    }
    ...
    pub fn is_rts_if_direction_co(&self) -> bool {
        *self == Uart1Rs485ctrlSelEnum::RtsIfDirectionCo
    }
    ...
    pub fn is_dtr_if_direction_co(&self) -> bool {
        *self == Uart1Rs485ctrlSelEnum::DtrIfDirectionCo
    }
}
#[doc = "Field `SEL` writer - Direction control."]
pub type SelW<'a, REG> = crate::BitWriter<'a, REG, Uart1Rs485ctrlSelEnum>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn rts_if_direction_co(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlSelEnum::RtsIfDirectionCo)
    }
    #[doc = "DTR. If direction control is enabled (bit DCTRL = 1), pin DTR is used for direction control."]
    #[inline(always)]
    pub fn dtr_if_direction_co(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlSelEnum::DtrIfDirectionCo)
    }
}
#[doc = "Direction control enable.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Uart1Rs485ctrlDctrlEnum {
    #[doc = "0: Disable Auto Direction Control."]
    DisableAutoDirecti = 0,
    #[doc = "1: Enable Auto Direction Control."]
    EnableAutoDirectio = 1,
}
impl From<Uart1Rs485ctrlDctrlEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlDctrlEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DCTRL` reader - Direction control enable."]
pub type DctrlR = crate::BitReader<Uart1Rs485ctrlDctrlEnum>;
impl DctrlR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlDctrlEnum {
        match self.bits {
            false => Uart1Rs485ctrlDctrlEnum::DisableAutoDirecti,
            true => Uart1Rs485ctrlDctrlEnum::EnableAutoDirectio,
        }
    }
    #[doc = "Disable Auto Direction Control."]
    #[inline(always)]
    pub fn is_disable_auto_directi(&self) -> bool {
        *self == Uart1Rs485ctrlDctrlEnum::DisableAutoDirecti
    }
    #[doc = "Enable Auto Direction Control."]
    #[inline(always)]
    pub fn is_enable_auto_directio(&self) -> bool {
        *self == Uart1Rs485ctrlDctrlEnum::EnableAutoDirectio
    }
}
#[doc = "Field `DCTRL` writer - Direction control enable."]
pub type DctrlW<'a, REG> = crate::BitWriter<'a, REG, Uart1Rs485ctrlDctrlEnum>;
...
impl From<Uart1Rs485ctrlOinvEnum> for bool {
    #[inline(always)]
    fn from(variant: Uart1Rs485ctrlOinvEnum) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `OINV` reader - Polarity. This bit reverses the polarity of the direction control signal on the RTS (or DTR) pin."]
pub type OinvR = crate::BitReader<Uart1Rs485ctrlOinvEnum>;
impl OinvR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Uart1Rs485ctrlOinvEnum {
        match self.bits {
            false => Uart1Rs485ctrlOinvEnum::LowTheDirectionC,
            true => Uart1Rs485ctrlOinvEnum::HighTheDirection_,
        }
    }
    ...
    pub fn is_low_the_direction_c(&self) -> bool {
        *self == Uart1Rs485ctrlOinvEnum::LowTheDirectionC
    }
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn low_the_direction_c(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlOinvEnum::LowTheDirectionC)
    }
    #[doc = "HIGH. The direction control pin will be driven to logic 1 when the transmitter has data to be sent. It will be driven to logic 0 after the last bit of data has been transmitted."]
    #[inline(always)]
    pub fn high_the_direction_(self) -> &'a mut crate::W<REG> {
        self.variant(Uart1Rs485ctrlOinvEnum::HighTheDirection_)
    }
}
impl R {
