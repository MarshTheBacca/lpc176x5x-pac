...
pub type P1_0W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_0, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_0::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_0::Reserved3)
    }
}
...
pub type P1_1W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_1, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_1::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_1::Reserved3)
    }
}
...
pub type P1_4W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_4, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_4::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_4::Reserved3)
    }
}
...
pub type P1_8W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_8, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_8::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_8::Reserved3)
    }
}
...
pub type P1_9W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_9, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_9::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_9::Reserved3)
    }
}
...
impl P1_10R {
    ...
    #[inline(always)]
    pub fn is_reserved_2(&self) -> bool {
        *self == P1_10::Reserved2
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn is_reserved_3(&self) -> bool {
        *self == P1_10::Reserved3
    }
}
#[doc = "Field `P1_10` writer - Pin function select P1.10."]
pub type P1_10W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_10, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_10::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_10::Reserved3)
    }
}
...
impl P1_14R {
    ...
    #[inline(always)]
    pub fn is_reserved_2(&self) -> bool {
        *self == P1_14::Reserved2
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn is_reserved_3(&self) -> bool {
        *self == P1_14::Reserved3
    }
}
#[doc = "Field `P1_14` writer - Pin function select P1.14."]
pub type P1_14W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_14, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_14::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_14::Reserved3)
    }
}
...
impl P1_15R {
    ...
    #[inline(always)]
    pub fn is_reserved_2(&self) -> bool {
        *self == P1_15::Reserved2
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn is_reserved_3(&self) -> bool {
        *self == P1_15::Reserved3
    }
}
#[doc = "Field `P1_15` writer - Pin function select P1.15."]
pub type P1_15W<'a, REG> = crate::FieldWriter<'a, REG, 2, P1_15, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn reserved_2(self) -> &'a mut crate::W<REG> {
        self.variant(P1_15::Reserved2)
    }
    #[doc = "Reserved"]
    #[inline(always)]
    pub fn reserved_3(self) -> &'a mut crate::W<REG> {
        self.variant(P1_15::Reserved3)
    }
}
impl R {
...
impl W {
    #[doc = "Bits 0:1 - Pin function select P1.0."]
    #[inline(always)]
    pub fn p1_0(&mut self) -> P1_0W<'_, Pinsel2Spec> {
        P1_0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Pin function select P1.1."]
    #[inline(always)]
    pub fn p1_1(&mut self) -> P1_1W<'_, Pinsel2Spec> {
        P1_1W::new(self, 2)
    }
    #[doc = "Bits 8:9 - Pin function select P1.4."]
    #[inline(always)]
    pub fn p1_4(&mut self) -> P1_4W<'_, Pinsel2Spec> {
        P1_4W::new(self, 8)
    }
    #[doc = "Bits 16:17 - Pin function select P1.8."]
    #[inline(always)]
    pub fn p1_8(&mut self) -> P1_8W<'_, Pinsel2Spec> {
        P1_8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Pin function select P1.9."]
    #[inline(always)]
    pub fn p1_9(&mut self) -> P1_9W<'_, Pinsel2Spec> {
        P1_9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Pin function select P1.10."]
    #[inline(always)]
    pub fn p1_10(&mut self) -> P1_10W<'_, Pinsel2Spec> {
        P1_10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Pin function select P1.14."]
    #[inline(always)]
    pub fn p1_14(&mut self) -> P1_14W<'_, Pinsel2Spec> {
        P1_14W::new(self, 22)
    }
    #[doc = "Bits 30:31 - Pin function select P1.15."]
    #[inline(always)]
    pub fn p1_15(&mut self) -> P1_15W<'_, Pinsel2Spec> {
        P1_15W::new(self, 30)
    }
}
