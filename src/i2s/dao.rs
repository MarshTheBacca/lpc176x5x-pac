...
impl From<I2sDaoWordwidthEnum> for u8 {
    #[inline(always)]
    fn from(variant: I2sDaoWordwidthEnum) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for I2sDaoWordwidthEnum {
    type Ux = u8;
}
impl crate::IsEnum for I2sDaoWordwidthEnum {}
#[doc = "Field `WORDWIDTH` reader - Selects the number of bytes in data as follows:"]
pub type WordwidthR = crate::FieldReader<I2sDaoWordwidthEnum>;
impl WordwidthR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<I2sDaoWordwidthEnum> {
        match self.bits {
            0 => Some(I2sDaoWordwidthEnum::_8BitData),
            1 => Some(I2sDaoWordwidthEnum::_16BitData),
            3 => Some(I2sDaoWordwidthEnum::_32BitData),
            _ => None,
        }
    }
    #[doc = "8-bit data"]
    ...
    pub fn is_8_bit_data(&self) -> bool {
        *self == I2sDaoWordwidthEnum::_8BitData
    }
    #[doc = "16-bit data"]
    #[inline(always)]
    pub fn is_16_bit_data(&self) -> bool {
        *self == I2sDaoWordwidthEnum::_16BitData
    }
    #[doc = "32-bit data"]
    #[inline(always)]
    pub fn is_32_bit_data(&self) -> bool {
        *self == I2sDaoWordwidthEnum::_32BitData
    }
}
#[doc = "Field `WORDWIDTH` writer - Selects the number of bytes in data as follows:"]
pub type WordwidthW<'a, REG> = crate::FieldWriter<'a, REG, 2, I2sDaoWordwidthEnum>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn _8_bit_data(self) -> &'a mut crate::W<REG> {
        self.variant(I2sDaoWordwidthEnum::_8BitData)
    }
    #[doc = "16-bit data"]
    #[inline(always)]
    pub fn _16_bit_data(self) -> &'a mut crate::W<REG> {
        self.variant(I2sDaoWordwidthEnum::_16BitData)
    }
    #[doc = "32-bit data"]
    #[inline(always)]
    pub fn _32_bit_data(self) -> &'a mut crate::W<REG> {
        self.variant(I2sDaoWordwidthEnum::_32BitData)
    }
}
